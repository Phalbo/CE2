...
const VOCAL_STYLE_PROFILES = {
    "rgegnstmch": {
        ...
        rest_rules: [
            ...
            { duration_type: 'pause_skip', probability: 0.1 }
        ],
    ...
    "pnkfloyd": {
        ...
        rest_rules: [
            ...
            { duration_type: 'quarter', probability: 0.1, relative_to_beat: true },
            { duration_type: 'pause_skip', probability: 0.1 }
        ],
    ...
    "tmwts": {
        ...
        rest_rules: [
            { duration_type: 'half', probability: 0.2, relative_to_beat: true },
            { duration_type: 'quarter', probability: 0.1, relative_to_beat: true },
            { duration_type: 'eighth_unpredictable', probability: 0.1, relative_to_beat: true},
            { duration_type: 'pause_skip', probability: 0.1 }
        ],
    ...
    "yrk": {
        ...
        rest_rules: [
            { duration_type: 'sixteenth_abrupt', probability: 0.2, relative_to_beat: true },
            { duration_type: 'eighth_frequent', probability: 0.1, relative_to_beat: true },
            { duration_type: 'pause_skip', probability: 0.1 }
        ],
    ...
    "btlsxp": {
        ...
        rest_rules: [
            { duration_type: 'quarter_phrased', probability: 0.2, relative_to_beat: true },
            { duration_type: 'eighth', probability: 0.1, relative_to_beat: true },
            { duration_type: 'pause_skip', probability: 0.1 }
        ],
    ...
    "fmrcry": {
        ...
        rest_rules: [
            { duration_type: 'half_dramatic', probability: 0.2, relative_to_beat: true },
            { duration_type: 'quarter_breath', probability: 0.1, relative_to_beat: true },
            { duration_type: 'pause_skip', probability: 0.1 }
        ],
    ...
    "bllylsh": {
        ...
        rest_rules: [
            ...
            { duration_type: 'quarter_gap', probability: 0.1, relative_to_beat: true },
            { duration_type: 'pause_skip', probability: 0.1 }
        ],
